...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='adt',
            options={'ordering': ['-published'], 'verbose_name': 'Обявление', 'verbose_name_plural': 'Обьявления'},
        ),
        ...
        migrations.AddField(
            model_name='adt',
            name='rubric',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='adt.rubric', verbose_name='Рубрика'),
        ),
    ]
